export const expectedPublicDocsCommands = [
  ...
  "docs/cli-commands.md: npm run reclaim:help",
  "docs/cli-commands.md: npm run reclaim:help",
  "docs/cli-commands.md: npm run reclaim:help -- --include-optional",
  "docs/cli-commands.md: npm run reclaim:onboarding",
  "docs/cli-commands.md: npm run reclaim:config:status -- --config config/reclaim.local.json",
  "docs/cli-commands.md: npm run reclaim:tasks:preview-create -- --input examples/tasks.example.json",
  "docs/cli-commands.md: npm run reclaim:demo:mock-api -- --input examples/tasks.example.json",
  "docs/cli-commands.md: npm run reclaim:health -- --config config/reclaim.local.json",
  "docs/cli-commands.md: npm run reclaim:time-policies:list -- --config config/reclaim.local.json",
  "docs/cli-commands.md: npm run reclaim:tasks:list -- --config config/reclaim.local.json",
  "docs/cli-commands.md: npm run reclaim:tasks:filter -- --config config/reclaim.local.json --title-contains notes --event-category WORK",
  "docs/cli-commands.md: npm run reclaim:tasks:export -- --config config/reclaim.local.json --event-category WORK --format csv",
  "docs/cli-commands.md: npm run reclaim:tasks:create -- --config config/reclaim.local.json --input examples/tasks.example.json --confirm-write",
  "docs/cli-commands.md: npm run reclaim:tasks:update -- --config config/reclaim.local.json --input examples/task-updates.example.json --confirm-write",
  "docs/cli-commands.md: npm run reclaim:tasks:retarget -- --config config/reclaim.local.json --input examples/task-retarget.example.json --confirm-write",
  "docs/cli-commands.md: npm run reclaim:tasks:cleanup-duplicates -- --config config/reclaim.local.json --input examples/tasks.example.json --confirm-reviewed-delete",
  "docs/cli-commands.md: npm run reclaim:help",
  "docs/cli-commands.md: npm run reclaim:help -- --include-optional",
  "docs/cli-commands.md: npm run reclaim:onboarding",
  "docs/cli-commands.md: npm run reclaim:config:status -- --config config/reclaim.local.json",
  "docs/cli-commands.md: npm run reclaim:support:bundle -- --input examples/support-bundle-preview.example.json",
  "docs/cli-commands.md: npm run reclaim:health -- --config config/reclaim.local.json",
  "docs/cli-commands.md: npm run reclaim:openapi:capability-matrix",
  "docs/cli-commands.md: npm run reclaim:openapi:capability-matrix -- --input generated/reclaim-openapi/reclaim-api-0.1.raw.yml",
  "docs/cli-commands.md: npm run reclaim:time-policies:list -- --config config/reclaim.local.json",
  "docs/cli-commands.md: npm run reclaim:time-policies:explain-conflicts -- --input examples/time-policy-conflicts.example.json",
  "docs/cli-commands.md: npm run reclaim:demo:mock-api -- --input examples/tasks.example.json",
  "docs/cli-commands.md: npm run reclaim:demo:mock-api -- --profile failure-modes",
  "docs/cli-commands.md: npm run reclaim:tasks:preview-create -- --input examples/tasks.example.json",
  "docs/cli-commands.md: npm run reclaim:tasks:preview-create -- --input examples/scheduling-recipes.example.json",
  "docs/cli-commands.md: npm run reclaim:tasks:preview-create -- --input examples/shopping-errand-windows.example.json",
  "docs/cli-commands.md: npm run reclaim:tasks:preview-create -- --input examples/event-prep-block-example-pack.example.json",
  "docs/cli-commands.md: npm run reclaim:tasks:preview-create -- --input examples/todoist-starter-pack.example.json",
  "docs/cli-commands.md: npm run reclaim:tasks:preview-create -- --input examples/linear-starter-pack.example.json",
  "docs/cli-commands.md: npm run reclaim:tasks:preview-create -- --input examples/github-starter-pack.example.json",
  "docs/cli-commands.md: npm run reclaim:tasks:preview-create -- --input examples/agent-ops-week-scenario-pack.example.json",
  "docs/cli-commands.md: npm run reclaim:tasks:preview-update -- --input examples/task-updates.example.json",
  "docs/cli-commands.md: npm run reclaim:tasks:preview-retarget -- --input examples/task-retarget.example.json",
  "docs/cli-commands.md: npm run reclaim:tasks:list -- --config config/reclaim.local.json",
  "docs/cli-commands.md: npm run reclaim:tasks:filter -- --config config/reclaim.local.json --title-contains notes --event-category WORK",
  "docs/cli-commands.md: npm run reclaim:tasks:export -- --config config/reclaim.local.json --event-category WORK --format csv",
  "docs/cli-commands.md: npm run reclaim:tasks:inspect-duplicates -- --config config/reclaim.local.json --input examples/tasks.example.json",
  "docs/cli-commands.md: npm run reclaim:tasks:validate-write-receipts -- --config config/reclaim.local.json --input examples/task-write-receipts.example.json",
  "docs/cli-commands.md: npm run reclaim:tasks:create -- --config config/reclaim.local.json --input examples/tasks.example.json --confirm-write",
  "docs/cli-commands.md: npm run reclaim:tasks:update -- --config config/reclaim.local.json --input examples/task-updates.example.json --confirm-write",
  "docs/cli-commands.md: npm run reclaim:tasks:retarget -- --config config/reclaim.local.json --input examples/task-retarget.example.json --confirm-write",
  "docs/cli-commands.md: npm run reclaim:tasks:cleanup-duplicates -- --config config/reclaim.local.json --input examples/tasks.example.json --confirm-reviewed-delete",
  "docs/cli-commands.md: npm run reclaim:scenarios:preview-weekly -- --input examples/compound-weekly-preview.example.json",
  "docs/cli-commands.md: npm run reclaim:habits:preview-create -- --input examples/habits.example.json",
  "docs/cli-commands.md: npm run reclaim:focus:preview-create -- --input examples/focus-and-buffers.example.json",
  "docs/cli-commands.md: npm run reclaim:buffers:preview-create -- --input examples/focus-and-buffers.example.json",
  "docs/cli-commands.md: npm run reclaim:buffers:preview-rule -- --input examples/buffer-rules.example.json",
  "docs/cli-commands.md: npm run reclaim:buffers:preview-template -- --input examples/buffer-templates.example.json",
  "docs/cli-commands.md: npm run reclaim:meetings:preview-availability -- --input examples/meeting-availability.example.json",
  "docs/cli-commands.md: npm run reclaim:meetings:preview-recurring-reschedule -- --input examples/recurring-meeting-reschedule.example.json",
  "docs/cli-commands.md: npm run reclaim:meetings-hours:preview-inspect -- --input examples/meetings-and-hours.example.json",
  "docs/cli-commands.md: npm run reclaim:meetings-hours:preview-switch -- --input examples/meetings-hours-profile-switch.example.json",
  "docs/cli-commands.md: npm run reclaim:hours-config:preview-audit -- --input examples/hours-config.example.json",
  "docs/cli-commands.md: npm run reclaim:hours-config:preview-diff -- --input examples/hours-config-diff.example.json",
  "docs/cli-commands.md: npm run reclaim:account-audit:preview-inspect -- --input examples/account-audit.example.json",
  "docs/cli-commands.md: npm run reclaim:account-audit:preview-drift -- --input examples/account-audit-drift.example.json",
  "docs/cli-commands.md: npm run reclaim:meetings-hours:inspect -- --config config/reclaim.local.json",
  "docs/cli-commands.md: npm run reclaim:hours-config:audit -- --config config/reclaim.local.json",
  "docs/cli-commands.md: npm run reclaim:account-audit:inspect -- --config config/reclaim.local.json",
  "docs/cli-commands.md: npm run reclaim:mcp:mock-readonly -- --input examples/mock-readonly-mcp.example.json",
  "docs/cli-commands.md: npm run reclaim:openapi:generate",
  ...
  "docs/mock-readonly-mcp.md: npm run reclaim:mcp:mock-readonly -- --input examples/mock-readonly-mcp.example.json",
  ...
  "docs/tasks.md: npm run reclaim:tasks:preview-update -- --input examples/task-updates.example.json",
  "docs/tasks.md: npm run reclaim:tasks:update -- --config config/reclaim.local.json --input examples/task-updates.example.json --confirm-write",
  "docs/tasks.md: npm run reclaim:tasks:preview-retarget -- --input examples/task-retarget.example.json",
  "docs/tasks.md: npm run reclaim:tasks:retarget -- --config config/reclaim.local.json --input examples/task-retarget.example.json --confirm-write",
  ...
  "examples/README.md: npm run reclaim:mcp:mock-readonly -- --input examples/mock-readonly-mcp.example.json",
  ...
  "examples/README.md: npm run reclaim:tasks:preview-update -- --input examples/task-updates.example.json",
  "examples/README.md: npm run reclaim:tasks:update -- --config config/reclaim.local.json --input examples/task-updates.example.json --confirm-write",
  "examples/README.md: npm run reclaim:tasks:preview-retarget -- --input examples/task-retarget.example.json",
  "examples/README.md: npm run reclaim:tasks:retarget -- --config config/reclaim.local.json --input examples/task-retarget.example.json --confirm-write",
