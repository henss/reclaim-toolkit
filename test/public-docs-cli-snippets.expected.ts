export const expectedPublicDocsCommands = [
  ...
  "README.md: npm run reclaim:mcp:mock-readonly -- --input examples/mock-readonly-mcp.example.json",
  ...
  "README.md: npm run reclaim:tasks:preview-update -- --input examples/task-updates.example.json",
  ...
  "README.md: npm run reclaim:tasks:update -- --config config/reclaim.local.json --input examples/task-updates.example.json --confirm-write",
